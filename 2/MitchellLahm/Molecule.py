...
class Molecule(object):
	...
	def copy(self):
		...
		molecule.units = copy.deepcopy(self.units)
		molecule.natom = copy.deepcopy(self.natom)
		molecule.labels = copy.deepcopy(self.labels)
		molecule.masses = copy.deepcopy(self.masses)
		molecule.charges = copy.deepcopy(self.charges)
		molecule.geom = copy.deepcopy(self.geom)
		return molecule
